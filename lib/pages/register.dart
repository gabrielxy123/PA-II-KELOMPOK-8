...
class _RegisterState extends State<Register> {
  ...
  void _register(String name, String email, String password, String phone) async {
                ...
                children: [
                  ...
                  AppButton(
                    ...
                    onPressed: () {
                      ...
                      _register(nameController.text, passwordController.text, emailController.text, phoneController.text);
                    },
                  ),
                  SizedBox(height: 10),
                  Center(
