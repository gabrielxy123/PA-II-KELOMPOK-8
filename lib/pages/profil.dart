  ...
  Future<String?> _uploadToLaravelServer(String token) async {
    try {
      ...
      var request = http.MultipartRequest('POST',
          Uri.parse('http://192.168.18.9:8000/api/upload-profile-image'));
  ...
  Future<UserProfile> fetchUserProfile() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('http://192.168.18.9:8000/api/user-profil'),
        headers: {
  ...
  Future<void> updateProfile() async {
    try {
      ...
      final response = await http.post(
        Uri.parse('http://192.168.18.9:8000/api/update-profile'),
        headers: {
          'Authorization': 'Bearer $token',
          'Content-Type': 'application/json',
          'Accept': 'application/json',
